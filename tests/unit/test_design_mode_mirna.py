...
class TestMiRNADesigner:
    ...
    def test_mirna_designer_supplementary_score(self):
        ...
        # Test sequence with high A/U content in positions 13-16
        guide_high_au = "AAAAAAAAAAAAAAUUUAAAA"  # Positions 13-16: UUUA (75% A/U)
        score_high = designer._calculate_supplementary_score(guide_high_au)
        assert score_high > 0.5  # Should be high score (low pairing)
        
        # Test sequence with low A/U content in positions 13-16
        guide_low_au = "AAAAAAAAAAAAGGGCAAAA"  # Positions 13-16: GGGC (0% A/U)
