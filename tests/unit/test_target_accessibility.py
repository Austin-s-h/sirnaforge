...
def test_composite_term_set_names_the_quantity_it_computes():
    ...
    0.35 declared at the design stage, 0.10 post-screen; 3.0.0 -> 4.0.0 -> 4.1.0). What #95 pinned and this
    ...
    assert ScoringWeights().postscreen_sirna.target_accessibility == pytest.approx(0.10)
