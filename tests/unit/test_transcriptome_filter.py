...
class TestTranscriptFilter:
    ...
    def test_is_protein_coding_positive(self):
        ...
        record = SeqRecord(Seq("ATCG"), id="ENST001", description="gene_biotype:protein_coding")
    ...
    def test_is_protein_coding_negative(self):
        ...
        record = SeqRecord(Seq("ATCG"), id="ENST002", description="gene_biotype:lncRNA")
    ...
    def test_is_canonical_negative(self):
        ...
        record = SeqRecord(Seq("ATCG"), id="ENST002", description="gene_biotype:protein_coding")
