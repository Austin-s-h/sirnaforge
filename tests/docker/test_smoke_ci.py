...
def test_docker_smoke_basic_functionality():
    ...
    try:
        ...
        try:
            from sirnaforge.core import validation
            ...
            for seq in test_sequences:
                ...
                try:
                    ...
                    if hasattr(validation, 'validate_rna_sequence'):
                        result = validation.validate_rna_sequence(seq)
                        print(f"✅ Sequence validation worked for {seq[:20]}...")
                    else:
                        print(f"⚠️ No validate_rna_sequence function found (expected in minimal setup)")
                except Exception as e:
