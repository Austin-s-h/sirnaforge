...
- Pair with `--transcriptome-indices human:/refs/hs_cdna,mouse:/refs/mm_cdna` when you maintain your own cDNA BWA-MEM2 indices.
...
- Override indices with `--transcriptome-indices human:/refs/hs_cdna,mouse:/refs/mm_cdna` for custom BWA-MEM2 builds.
